...
const Hero = () => (
  <div className="pt-24 pb-16 bg-gradient-to-r from-blue-50 to-sky-50">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
